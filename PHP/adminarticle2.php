...
// Construct de la class AdminArticleM
    ...
    function Afficherarticle() {
        ...
        $st .= "</tr>";
        $st .= "</table>";
        $st .= "</form><tr><a href='../PHP/Index.php'>Retour à la section Administrateur</a></tr>";
    ...
    function ChargerDonnee() {
        ...
        if (isset($_REQUEST["champ"])) {
            ...
            $r = mysqli_query($this->cn, "select ". TARTID .",". TARTIMG .",". TARTTIT .",".TCATLIBELLE .",". TMARQUELIBELLEM .",". TARTDESC .",". TARTPRIX .",". TARTREFM .",". TARTREFC .",". TARTREFP .",". TARTETAT .",". TARTSTOCK .",". TARTDMEEV .",". TARTDC ." from ". TART .",". TMARQUE .",". TCAT ." where ". TARTREFM ." = ". TCATID ." and ". TARTREFC ." = ". TMARQUEID ." order by $champ $sens");
        } else {   
            $r = mysqli_query($this->cn, "select ". TART .".". TARTID .",". TARTIMG .",". TARTTIT .",". TCATLIBELLE .",". TMARQUELIBELLEM .",". TARTDESC .",". TARTPRIX .",". TARTREFM .",". TARTREFC .",". TARTREFP .",". TARTETAT .",". TARTSTOCK .",". TARTDMEEV .",". TARTDC ." from ". TART .",". TMARQUE .",". TCAT ." where ". TARTREFM ." = ". TMARQUE .".". TCATID ." and ". TARTREFC ." = ". TCAT .".". TMARQUEID ."");
        }
